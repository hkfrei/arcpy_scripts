...
arcpy.AddMessage("SKRIPT ZUM ERSTELLEN UND GLAETTEN VON HOEHENKURVEN IM FEATURE CLASS FORMAT")
arcpy.AddMessage("*******************************************************************************")
arcpy.AddMessage("")
try:
...
##    OutputFC = "D:\\gaga.gdb\\Test_lv95"
    ...
    arcpy.Project_management(OutputSmoothLine, OutputFC, lv95, transformation, ch1903)
